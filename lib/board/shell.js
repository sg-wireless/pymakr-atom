...
export default class Shell {
  ...
  readFile(name,callback){
    ...
    this.pyboard.exec_raw(command,function(err,content){
      ...
      var content_buffer = _this.utils.base64decode(content)
      var content_str = content_buffer.toString()
      console.log(content_buffer.length)
      // console.log(content_str)
      _this.logger.silly(err)
      // _this.logger.silly(content_str)
