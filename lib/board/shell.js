...
export default class Shell {
  ...
  decompress(name, execute, cb) {
    ...
    const command = `${'import uzlib\r\n' +
      'def decompress(name):\r\n' +
      "  with open('/flash/' + name,'r+') as d:\r\n" +
      '    c = uzlib.decompress(d.read())\r\n' +
      "  with open('/flash/' + name,'w') as d:\r\n" +
      '      d.write(c)\r\n' +
      '  del(c)\r\n' +
      "decompress('"}${name}')\r\n`;
  ...
  getHash(filename, cb) {
    ...
    const command =
      `${'import uhashlib,ubinascii,sys\r\n' +
        ...
        "with open('/flash/"}${filename}', 'rb') as f:\r\n` +
      '  while True:\r\n' +
