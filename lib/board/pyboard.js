...
export default class Pyboard {
  ...
  soft_reset(cb){
    ...
    this.send_wait_for_blocking(CTRL_D,wait_for,cb,5000)
  }
  ...
  receive(mssg,raw){
    ...
    console.log(this.receive_buffer.length)
  ...
  follow(cb){
    ...
    // setTimeout(function(){
      cb(null,"")
    // },1000)
  //   this.wait_for(0x04,function(err,content){
  //     _this.logger.verbose("Got first EOF")
  //     if(err){
  //       console.log(err)
  //       cb(err,content)
  //     }else{
  ...
  //       cb(err,data)
  //       // _this.wait_for(0x04,function(err,content){
  //       //   _this.logger.verbose("Got second EOF")
  //       //   if(err){
  //       //     console.log(err)
  //       //     cb(err,content)
  //       //   }else{
  //       //     _this.logger.verbose("Got returned content")
  //       //     _this.logger.silly(content)
  //       //     data_err = content.slice(0,-1)
  //       //     cb(PyboardError(data_err),content)
  //       //   }
  //       // },100)
  //     }
  //   },2000)
