...
export default class Monitor {
  ...
  readFile(name,cb){
    ...
    get_file_command = "f = open('"+name+"', 'rb')\r\n"
    this.pyboard.exec_raw_no_reset(get_file_command)

    import_commands = "import ubinascii\r\n" +
    "import sys\r\n"
    this.pyboard.exec_raw_no_reset(import_commands)
