...
// 'Microsoft' and 'Microchip Technology, Inc.' manufacturers show on boards with a PIC on windows
  static COMPORT_MANUFACTURERS = ['Pycom','Pycom Ltd.','FTDI','Microsoft','Microchip Technology, Inc.']
  ...
  static comport_manufacturers(){
    return PySerial.COMPORT_MANUFACTURERS
  }
  ...
  static list(cb){
    SerialPort.list(function(err,ports){
      ...
      result = portnames.concat(other_portnames)
      manus = manufacturers.concat(other_manufacturers)
      cb(result,manus)
    })
  }
