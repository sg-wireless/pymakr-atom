...
export default class Config {
  static constants(){
    return {
      safeboot_version: 1150002, // 1.14.0.b2. TODO: change after actual firmware release
  ...
  static settings(){
    return {
      ...
      statusbar_buttons: {
          type: 'array',
          default: ["connect","upload","download","run"],
          title: 'Action buttons',
          description: "Determines which buttons are always visible in the bar above the terminal. All others will be grouped under the 'more' button. Options are: status, run, upload, download, disconnect, listserial, settings, projectsettings, getversion, getssid",
          order: 6
      },
    }
  }
