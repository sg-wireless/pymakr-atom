...
export default class Config {
  static constants(){
    return {
      ...
      term_rows: {default: 11,max: 30, min: 1},
  ...
  static settings(){
    return {
      ...
      fast_upload: {
          ...
          description: 'Only works on newer devices with 4mb of ram and firmware version 1.20.0 or up. Uses bigger batches and compresses larger (>4kb) files to make uploading faster.',
          order: 12
      }
    }
  }
