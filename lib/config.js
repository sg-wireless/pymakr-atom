...
export default class Config {
  static constants(){
    return {
      ...
      logging_level: 0, // 0=silly,1=verbose,2=info, 3 = warning, 4 = error. anything higher than 5 = off. see logger.js
      error_messages: {
        "EHOSTDOWN": "Host down",
      ...
      term_rows: {default: 17,max: 50, min: 1},
  ...
  static settings(){
    return {
      ...
      fast_upload: {
          ...
          description: 'Uses bigger batches and compresses larger (>4kb) files to make uploading faster. Only works on newer devices with 4mb of ram and firmware version >=1.20.0',
          order: 12
      },
      autoconnect_comport_manufacturers: {
          ...
          default: ['Pycom','Pycom Ltd.','Pycom Ltd','FTDI','Microsoft','Microchip Technology, Inc.'],
          order: 13
      },
    }
  }
