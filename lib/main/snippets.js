...
import ConfigSnippets from '../../snippets/index.js';
var fs = require('fs');
...
export default class Snippets {
  ...
  __prepareCustomSnippetsPath(){
    ...
    try {
      var snippets_index_content = fs.readFileSync(this.custom_snippets_index_path)
  ...
  list(){
    ...
    // custom snippets
    console.log(this.custom_snippets_index)
  ...
  create_new(snippet){
    ...
    snippet.id = id
    snippet.custom = true
    var filepath = this.custom_snippets_path + id + ".py"
