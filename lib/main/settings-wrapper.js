...
export default class SettingsWrapper extends EventEmitter {
  constructor() {
    ...
    this.default_settings = Config.settings()
    this.all_keys = Object.keys(this.default_settings)
  ...
  refresh(){
    ...
    console.log(this.sync_file_types)
  ...
  setProjectConfig(){
    // for(var i=0;i<this.all_keys.length;i++){
    //   var key = this.all_keys[i]
    //   this[key] = this.project_config[key]
    // }
