...
export default class PanelView extends EventEmitter {
  ...
  constructor(pyboard,settings) {
    ...
    this.option_global_settings = this.createButton('global_settings','div','','Global settings','')
    this.option_project_settings = this.createButton('project_settings','div','','Project settings','')
  ...
  createButton(id,type,icon,text,classname){
    var parent = this.button_settings_sub
