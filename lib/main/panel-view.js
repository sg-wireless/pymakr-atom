...
export default class PanelView extends EventEmitter {
  ...
  constructor(pyboard,settings) {
    ...
    this.button_sync_receive = buttons.appendChild(document.createElement('button'));
    this.button_sync_receive.innerHTML = '<span class="fa fa-download"></span> Download';
    ...
    _this.api.listenToProjectChange(function(path){
  ...
  setProjectName(project_path){
    ...
    if(project_path){
      ...
      this.project_path = "Unknown project"
    }
