...
export default class PanelView extends EventEmitter {
  ...
  showFeedbackPopup(){
    ...
    if(!this.feedback_popup_seen){
      this.feedback_question = this.element.appendChild(document.createElement('div'))
  ...
  buildTerminal(){
    ...
    // create terminal
    this.terminal = new Term(null,this.terminal_el,_this.element,this.pyboard,null)
