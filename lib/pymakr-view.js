...
export default class PymakrView {
  ...
  constructor(serializedState,pyboard,settings) {
    ...
    this.button_close.innerHTML = 'Close <span class="fa fa-chevron-down">';
    ...
    this.button_more.innerHTML = 'More <span class="fa down fa-chevron-down"></span><span class="fa up fa-chevron-up"></span>';
    ...
    this.option_project_settings = this.button_more_sub.appendChild(document.createElement('div'))
