...
export default class PymakrView {
  ...
  setTitle(status){
	  if(status === 'connected'){
   	   this.title.innerHTML = '<img class="logo" src="/Users/alex/.atom/packages/Pymakr/styles/assets/logo.png">  Connected<i class="fa fa-check fa-lg icon" id="green"></i>'
      }
	  else{
   	   this.title.innerHTML = '<img class="logo" src="/Users/alex/.atom/packages/Pymakr/styles/assets/logo.png">  Disconnected<i class="fa fa-times fa-lg icon" id="red"></i>'
	  }
  ...
  getCurrentFile(cb,onerror){
    this.api.getCurrentFile(function(file){
